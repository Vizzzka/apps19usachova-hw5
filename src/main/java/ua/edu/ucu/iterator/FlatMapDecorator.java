...
public class FlatMapDecorator extends IteratorDecorator{
    ...
    public FlatMapDecorator(AsIntStreamIterator iterator, IntToIntStreamFunction toStream) {
        super(iterator);
    ...
    public Integer next() {
        ...
        if (currentStreamPosition == currentStreamArray.length) {
            ...
            this.currentStreamPosition = 0;
            this.currentStreamArray = this.toStream.applyAsIntStream(value).toArray();
        }
